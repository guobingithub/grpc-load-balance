...
func init() {
	proto.RegisterType((*DemoRequest)(nil), "demopb.DemoRequest")
	proto.RegisterType((*DemoResponse)(nil), "demopb.DemoResponse")
}
...
var fileDescriptor_65d71fe0140170a2 = []byte{
	...
	0x49, 0xcd, 0xcd, 0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x03, 0xb1, 0x0b, 0x92, 0x94,
	0x14, 0xb9, 0xb8, 0x5d, 0x52, 0x73, 0xf3, 0x83, 0x52, 0x0b, 0x4b, 0x53, 0x8b, 0x4b, 0x84, 0x84,
	0xb8, 0x58, 0xf2, 0x12, 0x73, 0x53, 0x25, 0x18, 0x15, 0x18, 0x35, 0x38, 0x83, 0xc0, 0x6c, 0x25,
	0x25, 0x2e, 0x1e, 0x88, 0x92, 0xe2, 0x82, 0xfc, 0xbc, 0xe2, 0x54, 0x6c, 0x6a, 0x8c, 0x3c, 0x21,
	0xc6, 0x04, 0xa7, 0x16, 0x95, 0x65, 0x26, 0xa7, 0x0a, 0x59, 0x41, 0xb8, 0x1e, 0x89, 0x79, 0x29,
	0x39, 0xa9, 0x45, 0x42, 0xc2, 0x7a, 0x10, 0xdb, 0xf4, 0x90, 0xac, 0x92, 0x12, 0x41, 0x15, 0x84,
	0x18, 0xae, 0xc4, 0x90, 0xc4, 0x06, 0x76, 0xa0, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x67, 0x20,
	0xb0, 0x9a, 0xb1, 0x00, 0x00, 0x00,
}
...
func (c *demoServiceClient) DemoHandler(ctx context.Context, in *DemoRequest, opts ...grpc.CallOption) (*DemoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/demopb.DemoService/DemoHandler", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedDemoServiceServer) DemoHandler(ctx context.Context, req *DemoRequest) (*DemoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DemoHandler not implemented")
}
...
func _DemoService_DemoHandler_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/demopb.DemoService/DemoHandler",
	}
